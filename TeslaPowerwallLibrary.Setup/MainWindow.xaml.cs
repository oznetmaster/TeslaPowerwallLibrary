...
/// resulting refresh and access tokens — the Windows equivalent of <c>python -m pypowerwall authtoken</c>.
/// </summary>
public partial class MainWindow : Window
	...
	private static void TryWriteError (string message)
		...
		try
			...
			{
			// No redirected error stream available — nothing more we can do.
			}
		}
